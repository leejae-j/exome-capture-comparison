...
* TPM files and deidentified survival data with subtype calls from whole transcriptome and exome capture RNA-seq can be found at GSE***.
* Subtype calls with basal-like probability by CLIA lab vs. whole transcriptome RNA-seq from the trial cohort can be found in **pancreas_trial_samples.csv**.
